  ...
  return (
    <>
      <div className="flex-row md:flex justify-between h-full">
        ...
        <div className="bg-[#F9F5EB] h-auto mx-auto py-10 px-5 md:px-20 lg:px-32">
          <div className="text-center w-full md:w-4/6 mx-auto">
            ...
            <p className="text-lg md:text-xl text-center ">
              You can request your custom food request like "Foods made with
              less oil" or With extra onions or no Sugar at all
            </p>
          </div>
